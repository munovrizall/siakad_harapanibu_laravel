    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ url('/laporan-akademik') }}">Laporan Akademik</a></div>
                <div class="breadcrumb-item">Semua Mata Pelajaran</div>
            </div>
        </div>
        <div class="section-body">
            <h2 class="section-title">Laporan Akademik</h2>
            <p class="section-lead">
                Anda dapat melihat semua nilai mata pelajaran.
            </p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <a href='{{ route('laporan-akademik.lihat-nilai', ['id_kelas' => $jadwal_pelajaran->id_kelas, 'id_matpel' => $jadwal_pelajaran->id_matpel]) }}' class="btn btn-sm btn-primary btn-icon" style="margin-right: 8px">
